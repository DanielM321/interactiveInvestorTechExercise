...
2. Logging in and out of the application
...
2. Logging in and out - Logging in especially is the first thing that an existing customer has to do in order to be able to interact with application and logging out also tests session management is functioning correctly
